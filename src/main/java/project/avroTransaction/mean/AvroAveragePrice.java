package project.avroTransaction.mean;
    ...
    public static void main(String [] args) {
        ...
        sourceProcessor.foreach((x, y) -> {
            try {
                ...
                System.out.println("Total Size Retrieved "+Sells.getTotalListDrug().size());

                Sells.getTotalListDrug().entrySet().stream().forEach(u->System.out.println("CIP: "+u.getKey()+": "+(u.getValue().stream().mapToDouble(j->j.getPrix()).sum())/u.getValue().size()));
            }catch(Exception e){
